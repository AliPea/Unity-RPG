    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat1.xyz = fma(u_xlat0.xxx, input.TEXCOORD3.xyz, u_xlat2.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat2.xyz = fma(Globals.hlslcc_mtx4x4unity_ObjectToWorld[0].xyz, input.TEXCOORD0.xxx, u_xlat2.xyz);
    u_xlat2.xyz = fma(Globals.hlslcc_mtx4x4unity_ObjectToWorld[2].xyz, input.TEXCOORD0.zzz, u_xlat2.xyz);
